...
BEGIN
    ...
    BEGIN
        ;THROW 50002, 'Invalid Last Name', 2;
    END
    ...
    END TRY
    BEGIN CATCH
        THROW 50003, 'Invalid Date Format (YYYY-MM-DD)', 3;
        RETURN;
    END CATCH
...
-- go
-- EXEC add_new_reader @PESEL = '21111211111', @last_name='Po', @birth='2000-12-20';
-- go
-- for small letters
-- go
...
-- check date
go
EXEC add_new_reader @PESEL = '11724232311', @last_name='Boo', @birth='2000-12-31';
go