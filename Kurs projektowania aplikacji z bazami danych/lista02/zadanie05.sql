...
AS
BEGIN
    -- helper table to store already modified
    DROP TABLE IF EXISTS #updated
    CREATE TABLE #updated([ID] INT);

    -- updated is a table with already changed DiscontinuedDate column
    INSERT INTO #updated
    SELECT P.ProductID 
...
INSERT INTO @table([ID]) VALUES (680), (706), (707), (708), (709), (715)
